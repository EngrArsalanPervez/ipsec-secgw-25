...
const pkt_rules_t pkt_rules_h1[RTE_MAX_ETHPORTS] = {
    [0] = {
        .src_mac = {.addr_bytes = {0xaa, 0xbb, 0xcc, 0x00, 0x00, 0x00}},
...
const pkt_rules_t pkt_rules_l2[RTE_MAX_ETHPORTS] = {
    [0] = {
        .src_mac = {.addr_bytes = {0xae, 0xdd, 0xee, 0x10, 0x00, 0x01}},
...
const pkt_rules_t pkt_rules_l4[RTE_MAX_ETHPORTS] = {
    [0] = {
        .src_mac = {.addr_bytes = {0xae, 0xdd, 0xee, 0x10, 0x00, 0x02}},
...
const pkt_rules_t pkt_rules_l6[RTE_MAX_ETHPORTS] = {
    [0] = {
        .src_mac = {.addr_bytes = {0xae, 0xdd, 0xee, 0x10, 0x00, 0x03}},
