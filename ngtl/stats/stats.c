...
void printAppStats(void) {
    ...
    printf("eth:\t\t\t%30lu\t\t\t%30lu\n"
           ...
           appStatsData[1].ethTypeARP, appStatsData[0].ethTypeVLAN, appStatsData[1].ethTypeVLAN,
           appStatsData[0].ethTypeLLDP, appStatsData[1].ethTypeLLDP, appStatsData[0].ethTypeIPV4,
           appStatsData[1].ethTypeIPV4, appStatsData[0].ethTypeIPV6, appStatsData[1].ethTypeIPV6,
           appStatsData[0].ethTypeUNKNOWN, appStatsData[1].ethTypeUNKNOWN);
    ...
    printf("ipTypeTCP:\t\t%30lu\t\t\t%30lu\n"
           ...
           appStatsData[0].ipTypeTCP, appStatsData[1].ipTypeTCP, appStatsData[0].ipTypeUDP,
           appStatsData[1].ipTypeUDP, appStatsData[0].ipTypeICMP, appStatsData[1].ipTypeICMP,
           appStatsData[0].ipTypeESP, appStatsData[1].ipTypeESP, appStatsData[0].ipTypeIGMP,
           appStatsData[1].ipTypeIGMP, appStatsData[0].ipTypeOSPF, appStatsData[1].ipTypeOSPF,
           appStatsData[0].ipTypeGRE, appStatsData[1].ipTypeGRE, appStatsData[0].ipTypeUNKNOWN,
           appStatsData[1].ipTypeUNKNOWN);
    ...
    printf("udpTypeDNS:\t\t\t%30lu\t\t\t%30lu\n"
           ...
           appStatsData[0].udpServicesData.udpTypeDNS, appStatsData[1].udpServicesData.udpTypeDNS,
           appStatsData[0].udpServicesData.udpTypeDHCP, appStatsData[1].udpServicesData.udpTypeDHCP,
           appStatsData[0].udpServicesData.udpTypeNTP, appStatsData[1].udpServicesData.udpTypeNTP,
           appStatsData[0].udpServicesData.udpTypeSNMP, appStatsData[1].udpServicesData.udpTypeSNMP,
           appStatsData[0].udpServicesData.udpTypeSYSLOG,
           appStatsData[1].udpServicesData.udpTypeSYSLOG,
           appStatsData[0].udpServicesData.udpTypeRIP, appStatsData[1].udpServicesData.udpTypeRIP,
           appStatsData[0].udpServicesData.udpTypeRADIUS,
           appStatsData[1].udpServicesData.udpTypeRADIUS,
           appStatsData[0].udpServicesData.udpTypeX11, appStatsData[1].udpServicesData.udpTypeX11,
    ...
    printf("tcpTypeFTP:\t\t\t%30lu\t\t\t%30lu\n"
           ...
           appStatsData[0].tcpServicesData.tcpTypeFTP, appStatsData[1].tcpServicesData.tcpTypeFTP,
           appStatsData[0].tcpServicesData.tcpTypeSSH, appStatsData[1].tcpServicesData.tcpTypeSSH,
           appStatsData[0].tcpServicesData.tcpTypeTELNET,
           appStatsData[1].tcpServicesData.tcpTypeTELNET,
           appStatsData[0].tcpServicesData.tcpTypeSMTP, appStatsData[1].tcpServicesData.tcpTypeSMTP,
           appStatsData[0].tcpServicesData.tcpTypeHTTP, appStatsData[1].tcpServicesData.tcpTypeHTTP,
           ...
           appStatsData[0].tcpServicesData.tcpTypePPTP, appStatsData[1].tcpServicesData.tcpTypePPTP,
           appStatsData[0].tcpServicesData.tcpTypeMYSQL,
           appStatsData[1].tcpServicesData.tcpTypeMYSQL, appStatsData[0].tcpServicesData.tcpTypeRDP,
           appStatsData[1].tcpServicesData.tcpTypeRDP, appStatsData[0].tcpServicesData.tcpTypeVNC,
           ...
           appStatsData[0].tcpServicesData.tcpTypeBGP, appStatsData[1].tcpServicesData.tcpTypeBGP,
           appStatsData[0].tcpServicesData.tcpTypeSIP, appStatsData[1].tcpServicesData.tcpTypeSIP,
           appStatsData[0].tcpServicesData.tcpTypeLDAP, appStatsData[1].tcpServicesData.tcpTypeLDAP,
